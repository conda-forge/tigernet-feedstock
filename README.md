...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tigernet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11685&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tigernet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tigernet` can be installed with:

```
conda install tigernet
```

It is possible to list all of the versions of `tigernet` available on your platform with:
